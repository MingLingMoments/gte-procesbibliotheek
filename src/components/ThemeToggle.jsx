...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggle}
      className="relative w-12 h-6 rounded-full bg-gray-300 dark:bg-gray-600 transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#5BB446]/50"
